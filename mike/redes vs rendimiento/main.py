...
from procedures.procedures import get_high_math_scores, get_student_averages, avg_scores_by_ethnicity
...
def main():
    ...
    with sqlite3.connect(DB_FILE) as conn:
        ...
        if not table_has_data(cursor, "student_performance"):
            ...
            print(
                "La tabla 'student_performance' ya contiene datos. No se cargaron duplicados.")
        ...
        print_section_header(
            "Estudiantes con Alta Puntuación en Matemáticas (>85)")
...
if __name__ == "__main__":
    main()
>>>>>>> origin/main:mike/redes vs rendimiento/main.py
